...
- [Лабораторная работа 1 "SystemVerilog: типы данных"](#лабораторная-работа-1-systemverilog-типы-данных)
  ...
  - [Теория](#теория)
    ...
    - [Векторы (packed array)](#векторы-packed-array)
    - [Массивы (unpacked array)](#массивы-unpacked-array)
    - [Многомерные массивы](#многомерные-массивы)
      - [Многомерные массивы (multidimensional array)](#многомерные-массивы-multidimensional-array)
      - [Смешанные массивы (mixed-types array)](#смешанные-массивы-mixed-types-array)
    - [Контейнеры](#контейнеры)
      - [Очереди (queue)](#очереди-queue)
      - [Динамические массивы (open array)](#динамические-массивы-open-array)
    - [Вспомогательные типы](#вспомогательные-типы)
      ...
      - [Указатели (chandle)](#указатели-chandle)
...
#### Многомерные массивы (multidimensional array)

---

#### Смешанные массивы (mixed-types array)
...
#### Динамические массивы (open array)
